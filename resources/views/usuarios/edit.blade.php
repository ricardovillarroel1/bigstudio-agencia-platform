                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <x-text-input id="razon_social" class="block mt-1 w-full" type="text" name="razon_social" :value="old('razon_social', $cliente->razon_social ?? '')" placeholder="Nombre legal de la empresa" />
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-text-input id="rut" class="block mt-1 w-full" type="text" name="rut" :value="old('rut', $cliente->rut ?? '')" placeholder="Ej: 76.123.456-7" />
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-text-input id="giro" class="block mt-1 w-full" type="text" name="giro" :value="old('giro', $cliente->giro ?? '')" placeholder="Actividad económica" />
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-text-input id="direccion" class="block mt-1 w-full" type="text" name="direccion" :value="old('direccion', $cliente->direccion ?? '')" placeholder="Dirección fiscal" />
                                    <x-input-error :messages="$errors->get('direccion')" class="mt-2" />
                                </div>

                                @if($cliente && $cliente->razon_social && $cliente->rut && $cliente->giro && $cliente->direccion)
